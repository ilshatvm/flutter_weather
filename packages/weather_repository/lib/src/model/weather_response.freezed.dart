...
mixin _$WeatherResponse {
  ...
  @JsonKey(name: 'main')
  MainModel? get mainModel => throw _privateConstructorUsedError;
...
abstract class $WeatherResponseCopyWith<$Res> {
  ...
  $MainModelCopyWith<$Res>? get mainModel;
...
class _$WeatherResponseCopyWithImpl<$Res, $Val extends WeatherResponse>
  ...
  @pragma('vm:prefer-inline')
  $MainModelCopyWith<$Res>? get mainModel {
    if (_value.mainModel == null) {
      return null;
    }

    return $MainModelCopyWith<$Res>(_value.mainModel!, (value) {
      return _then(_value.copyWith(mainModel: value) as $Val);
    });
  }
...
class _$WeatherResponseImpl implements _WeatherResponse {
  const _$WeatherResponseImpl(
      ...
      this.base,
      @JsonKey(name: 'main') this.mainModel,
      this.visibility,
      this.wind,
      this.clouds,
      this.dt,
  ...
  @override
  String toString() {
    return 'WeatherResponse(coord: $coord, weather: $weather, base: $base, mainModel: $mainModel, visibility: $visibility, wind: $wind, clouds: $clouds, dt: $dt, sys: $sys, timezone: $timezone, id: $id, name: $name, cod: $cod)';
  }
...
abstract class _WeatherResponse implements WeatherResponse {
  const factory _WeatherResponse(
      ...
      final List<Weather>? weather,
      final String? base,
      @JsonKey(name: 'main') final MainModel? mainModel,
      final int? visibility,
      final Wind? wind,
      final Clouds? clouds,
      final int? dt,
